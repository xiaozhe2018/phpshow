...
{
    //模型类主操作表
    protected static $mod_table = 'bone_test_user';
    
    //模型类缓存前缀
    protected static $cache_prefix = 'bone_test_user';
    ...
    */
    public static function get_one( $pri_key )
    {
        ...
        $data = db::get_one("Select * From `".self::$mod_table."` where `admin_id` = '{$pri_key}' ");
        if( !empty($data) ) {
