...
function uploadSuccess(file, serverData) {
    ...
    try {
        ...
        if (serverData.substring(0, 7) != " ") {
			array = serverData.split(':#:');
            //addImage(serverData.substring(7));
			var obj = document.getElementById("thumbnails-lists_"+array[0]);
                obj.style.display = 'block';
			var oldHtml = obj.innerHTML;
			obj.innerHTML = oldHtml + array[1];
			//document.getElementById("thumbnails-lists").appendChild();
