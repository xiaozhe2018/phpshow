...
<dl class="tips">
    <dd>
     <strong>当前位置：</strong><a href='?ct=users&ac=edit_purview_groups'>权限管理</a> -- <{$group_name}> [<a href='?ct=system&ac=edit_purview_xml'>修改xml配置</a>]
    </dd>
</dl>
...
<div style='padding-left:10px;'>
    ...
    <div style='line-height:28px;width:90%;padding-top:10px;'>
       ...
       <{if $kk != 'app_name'  }>
       <{if $_block.foo.index > 1 && $_block.foo.index-1 % 4 == 0}><br /><{/if}>
