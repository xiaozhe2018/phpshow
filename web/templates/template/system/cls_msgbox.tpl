...
<body>
        <!--
    <div style="background:#c3d9eb;padding:5px;width:90%;margin:10px auto;">
        -->
        <div style="padding:5px;width:90%;margin:10px auto;">
        <!--
        ...
        <div>
            ...
            -->
            <h2 style="font-size:12px;height:28px; line-height:28px;padding:0 10px;background:#EEF8FF;"><{$title}></h2>
